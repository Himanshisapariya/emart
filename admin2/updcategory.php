...
<h1 class="mb-4 animate__animated animate__zoomIn">Update Products</h1>
<button type="button" class="btn btn-success btn-lg animate__animated animate__zoomIn" data-bs-toggle="modal" data-bs-target="#addproduct">
...
move_uploaded_file($_FILES['uimage'] ['tmp_name'],$path);
    ...
    $updatequery = "update category set cid=$id , cname='$name' ,cimage='$new_file_name' where cid=$id ";
